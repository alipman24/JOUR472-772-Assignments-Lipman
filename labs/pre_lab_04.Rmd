...
**Answer: Both methods returned roughly similar results except for the ordering of some words in the cleaned name. ngram_clean seems to be taking the version of the name that is further down on an alphabetical list, seeming to indicate that the function sorts the column first like that to identify the likeliest first instance.**
