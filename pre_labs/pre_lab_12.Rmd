...
**Task** Run the following code and describe the dataframe it outputs. **Answer:** The dataframe has the id data for the doctors and splits them by row.
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer:** The function removes any duplicate words based on characters and capitalization.
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer:** The function splits the text into its individual words.
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer:** The graphic shows the frequency for each word and how many times their unique variation appears.
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer:** Yes, the words now mean more than just placeholder prepositions or articles.
...
**Task** Run the following code and describe the results. **Answer:** The unique words and their percents are now split by year.
...
**Task** Run the following code and describe the results. **Answer:** The filters now make sure to omit words that have any parts involved in the stop words.
...
**Task** Run the following code and describe the results. **Answer:** The same process as earlier now just returns the top 10 entries for 2023 instead of all of the data.
...
**Task** Run the following code and describe the results. **Answer:** The same process as earlier now just returns the top 10 entries for 2024 instead of all of the data.
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer:** Some of the words do not cleanly match their positive or negative description. The word "like" is assigned as positive when it could just be acting as a point of comparison (ex. like a word). Significant is also labeled as positive when it could be referring to the amount of a negative thing.
