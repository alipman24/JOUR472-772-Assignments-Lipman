...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer: The table headings are not included with the rest of the data. It treats the first row like the headings instead of being part of the data.**
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer: The headings are still not present and the county names have the extra dots that are not being cleaned away.**
...
**Task** Run the codeblock below. What else do we need to do? **Answer: The county names still need to be fixed to not have the extra punctuation.**
