...
#1install.packages("rlang")
devtools::install_github("heurekalabsco/axolotr")
update.packages(ask = FALSE, checkBuilt = TRUE)
library(axolotr)
create_credentials(GROQ_API_KEY = "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")
```
...
```{r}
clean_text <- gsub('^"|"$', '', evans_response)
evans_response_df <- read_csv(clean_text)
```
