...
**Answer: Each line of code represents one term of classes and groups them to find the total number of classes offered in that term.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: The count_classes column is now sorted to have the largest values first and then descending from there.**
...
**Answer: The output now has rows for each unique combination of term and department name.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: There is now a new column that adds up the number of seats for each term.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer: There are now columns for the mean and median and the top terms are all for the one with the most total seats.**
...
**Answer: There are now columns for the minimum seats and maximum seats avaiable for the course. The data is sorted by the amount of total seats.**
...
1.  How have the mean and median seats changed by year instead of term?

2.  What formats are each course in and how does that affect the maximum seats?

3.  How can the data be filtered to omit big outliers/find a confidence interval?
