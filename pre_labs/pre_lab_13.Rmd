...
**Task** Run the following code. Describe the output. What do you see? **Answer:** The output is the results in the t test that show the data is statistically relevant since the p-value is below the 0.05 threshold.
