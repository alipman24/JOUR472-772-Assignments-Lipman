...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer:** The dataset has 3,822 rows and four columns.
...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer:** The mutate step adds a column for the month based on the information in date. The group_by combines all of the months. The summarize function counts how many calls were in each month after they were grouped. The arrange sorts the data by how many calls were in the month with the most at the top.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** I see a blank gray square with nothing in it.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** The box now has a bar graph with the month and total count for the calls. It is arranged in chronological order of the months.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer:** The graph has changed by the order of the data. It is now arranged by the number of total calls with the fewest at the left and going up as it goes right.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer:** The graph is now rotated to be horizontal and the data now has the largest month at the top and the smallest month by data at the bottom.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer:** The background is different because it does not have the gray shapes behind anymore.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer:** The theme is different and that has changed the background to be light blue.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer:** The labels are now different and specified in the code instead of being automatically generated.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** The number of total calls is displayed by grouped date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** The code is now a line chart that has three month intervals on the x axis and five call intervals on the y axis. It shows the changes in total calls by date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** The x axis label now has every week listed as the intervals.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer:** The text has been rotated by 45 degrees to be somewhat easier to read on the x axis since it is so small by week.
